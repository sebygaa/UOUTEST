...
#v = 0.05
N = 21              # -
MTC_input = float(sys.argv[2]) # Default = 0.05 (1/sec)
#MTC_input = 0.05
...
def iso_mix(P1, P2):
    q_tmp = ex_Lang([P1, P2], [iso_par1, iso_par2])
    q1, q2 = q_tmp
    return q1, q2
...
fnamCPU = 'res_ex'+ str(now.date())+'_v'+ sys.argv[1]+'_k'+ sys.argv[2] + '.txt'
fnamPick = 'res_ex'+ str(now.date())+'_v'+sys.argv[1]+ '_k'+sys.argv[2] + '.pkl'
