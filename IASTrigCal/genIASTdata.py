...
y1_ran = [y1_1, y1_2]
P_ran = [P_1, P_2]
q_inter_res = interLinIAST2D(y_targ, P_targ,
                          y1_ran, P_ran, 
                          q_11_arr,q_12_arr,
                          q_21_arr,q_22_arr)
print()
...
print('[[q_sol from interLinIAST2D]]')
print(q_sol)
# %%
# functionalize this
# %% 
def interLinIAST3D(y_targ, P_targ,
                y1_ran, P_ran, T_ran,
                q_list_T1, q_list_T2):
    q_sol_T1 = interLinIAST2D(y_targ, P_targ,
                           y1_ran,P_ran,
...
q_sol = interLinIAST3D(y_targ,P_targ,
                    [y1_1, y1_2],[P_1,P_2], [T_1,T_2],
                    q_T1, q_T2)

print('[[q_sol from interLinIAST3D]]')
print(q_sol)
# %%
# Generate IAST data 2D
# %%
# Increase the number at last => i = 200 & j = 500
y1_ran = np.linspace(0,1,400+1)
P_ran = np.linspace(0,25,800+1)
